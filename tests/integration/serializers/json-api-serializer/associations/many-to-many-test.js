...
module(
  ...
  function(hooks) {
    hooks.beforeEach(function() {
      ...
      let mushroomKingdom = schema.addresses.create({
        street: 'Some Mushroom Kingdom Street'
      });

      schema.contactAddresses.create({ contact: mario, address: newYork });
      schema.contactAddresses.create({
        contact: mario,
        address: mushroomKingdom
      });
      ...
      assert.deepEqual(included, [
        {
          ...
          relationships: {
            ...
            'contact-addresses': {
              data: [{ id: '1', type: 'contact-addresses' }]
            }
          }
        },
        {
          ...
          relationships: {
            contacts: { data: [{ id: '1', type: 'contacts' }] },
            'contact-addresses': {
              data: [{ id: '2', type: 'contact-addresses' }]
            }
          }
        }
      ]);
